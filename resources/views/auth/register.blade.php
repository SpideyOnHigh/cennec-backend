                        ...
                        <div class="flex h-[90vh] flex-col">
                            <div class="mx-auto">
                                <a href="{{ url('index') }}" class="">
                                    <img src="{{ URL::asset('build/images/logo.png') }}" alt=""
                                        ...
                                        class="text-xl align-middle font-medium ltr:ml-2 rtl:mr-2 dark:text-white">{{ env('APP_NAME', 'Cennec') }}</span>
                                </a>
                            </div>
                            ...
                            <div class="my-auto">
                                <div class="text-center">
                                    ...
                                    <p class="text-gray-500 mt-1 dark:text-zinc-100/60">Get your free {{ env('APP_NAME', 'Cennec') }} account now.</p>
                                </div>
                                ...
                                <div class="mt-4 pt-2 text-center">
                                    <div>
                                        <h6 class="text-14 mb-3 text-gray-500 font-medium dark:text-zinc-100/60">- Log in
                                            with -</h6>
                                    </div>
                            ...
                            <div class=" text-center">
                                <p class="text-gray-500 relative mb-5 dark:text-gray-100">©
                                    ...
                                    {{ env('APP_NAME', 'Cennec') }}. {{-- Crafted with <i
                                        class="mdi mdi-heart text-red-400"></i> by 9Series --}}
                                </p>
                            </div>
                        </div>
                    </div>
